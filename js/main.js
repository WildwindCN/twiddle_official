...
const translations = {
    en: {
        ...
        'engine-desc': 'Built on a Transformer architecture, Inspiration Engine 1.0 is Twiddle AI\'s end-to-end natural language-to-timbre synthesis algorithm. It translates natural language input into playable sound — from precise professional descriptors like <strong>"a bright, gritty, spacious vintage piano"</strong> to the poetic inspiration of <strong>"I wandered lonely as a cloud / That floats on high o\'er vales and hills."</strong> This is not preset browsing. It is timbre creation born from language.',
