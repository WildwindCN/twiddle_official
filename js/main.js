...
const translations = {
    ...
    zh: {
        ...
        'engine-title': 'Inspiration Engine 1.0',
        'engine-desc': 'Inspiration Engine 1.0 基于 Transformer 架构，是 Twiddle AI 自研的端到端自然语言到音色合成算法。它将文本转化为可演奏的声音——既能解析精确的专业描述，如"明亮的有颗粒感的强空间感的老式钢琴"，也能捕捉诗意灵感，如"I wandered lonely as a cloud / That floats on high o\'er vales and hills"。这不是预设浏览，而是诞生于语言的音色创造。',
